<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位编号" prop="zuoweibianhao">
          <el-input v-model="ruleForm.zuoweibianhao" 
              placeholder="座位编号" clearable  :readonly="ro.zuoweibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="座位编号" prop="zuoweibianhao">
              <el-input v-model="ruleForm.zuoweibianhao" 
                placeholder="座位编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="自习室" prop="zixishi">
          <el-select v-model="ruleForm.zixishi" placeholder="请选择自习室">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="自习室" prop="zixishi">
	      <el-input v-model="ruleForm.zixishi"
                placeholder="自习室" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="座位状态" prop="zuoweizhuangtai">
          <el-select v-model="ruleForm.zuoweizhuangtai" placeholder="请选择座位状态">
            <el-option
                v-for="(item,index) in zuoweizhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="座位状态" prop="zuoweizhuangtai">
	      <el-input v-model="ruleForm.zuoweizhuangtai"
