<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业分类" prop="zhuanyefenlei">
          <el-input v-model="ruleForm.zhuanyefenlei" 
              placeholder="专业分类" clearable  :readonly="ro.zhuanyefenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业分类" prop="zhuanyefenlei">
              <el-input v-model="ruleForm.zhuanyefenlei" 
                placeholder="专业分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='zhuanyefenlei'){
            this.ruleForm.zhuanyefenlei = obj[o];
	    this.ro.zhuanyefenlei = true;
            continue;
          }
	                    }
                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhuanyefenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhuanyefenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
