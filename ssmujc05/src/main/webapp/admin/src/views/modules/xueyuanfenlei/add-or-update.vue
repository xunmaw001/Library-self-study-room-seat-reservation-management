<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院分类" prop="xueyuanfenlei">
          <el-input v-model="ruleForm.xueyuanfenlei" 
              placeholder="学院分类" clearable  :readonly="ro.xueyuanfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院分类" prop="xueyuanfenlei">
              <el-input v-model="ruleForm.xueyuanfenlei" 
                placeholder="学院分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='xueyuanfenlei'){
            this.ruleForm.xueyuanfenlei = obj[o];
	    this.ro.xueyuanfenlei = true;
            continue;
          }
	                    }
                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueyuanfenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueyuanfenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
