          ...
          <el-form-item class="input" label="座位编号" prop="zuoweibianhao">
              <el-input v-model="ruleForm.zuoweibianhao" 
                placeholder="座位编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="自习室" prop="zixishi">
          <el-input v-model="ruleForm.zixishi" 
              placeholder="自习室" clearable  :readonly="ro.zixishi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="自习室" prop="zixishi">
              <el-input v-model="ruleForm.zixishi" 
                placeholder="自习室" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位状态" prop="zuoweizhuangtai">
          <el-input v-model="ruleForm.zuoweizhuangtai" 
              placeholder="座位状态" clearable  :readonly="ro.zuoweizhuangtai"></el-input>
        </el-form-item>
        <div v-else>
