	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`zhuanyefenlei`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																if(this.ruleForm.id){
					await this.$api.update(`zhuanyefenlei`, this.ruleForm);
				}else{
					await this.$api.add(`zhuanyefenlei`, this.ruleForm);
				}
